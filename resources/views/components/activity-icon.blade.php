...
<svg
    ...
    viewBox="0 0 24 24"
>
    <title>{{ $activity->label }}</title>
    @if ($activity->iconName() === "research")
        <path stroke="none" d="M0 0h24v24H0z" />
        <path d="M5 21h14M6 18h2m-1 0v3m2-10 3 3 6-6-3-3zm1.5 1.5L9 14m8-11 3 3" />
        <path d="M12 21a6 6 0 0 0 3.71-10.71" />
    @elseif ($activity->iconName() === "advocacy")
        <path stroke="none" d="M0 0h24v24H0z" />
        <path d="M18 8a3 3 0 0 1 0 6m-8-6v11a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-5" />
        <path d="M12 8h0l5-4a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1l-5-4H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h8" />
    @elseif ($activity->iconName() === "funding")
        <path stroke="none" d="M0 0h24v24H0z" />
    ...
    @elseif ($activity->iconName() === "technology")
        <path stroke="none" d="M0 0h24v24H0z" />
