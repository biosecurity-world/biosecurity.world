<div class="mx-auto w-full max-w-7xl px-6 xl:px-0">
    <nav
        {{ $attributes->merge(["class" => "md:border md:border-sand-300 md:bg-white md:rounded-full md:px-8 md:py-3 xl:-mx-8"]) }}
    >
        <ul class="items-center md:flex md:space-x-4 lg:-ml-2">
            <li
                class="font-display text-ink lg:hover:bg-primary-50 lg:focus:bg-primary-50 mr-4 mb-1.5 inline-block rounded-xl font-semibold tracking-tight underline focus:outline-hidden md:mb-0 lg:mr-0 lg:px-2 lg:no-underline lg:hover:underline"
            >
