...
<main class="max-w-7xl mx-auto mt-8 md:mt-12 px-6 md:px-14 xl:px-0">
    <div class="md:flex">
        <h2 class="order-1 flex-1 text-lg md:text-xl md:mt-2.5 lg:text-2xl font-display text-primary-950 md:text-right">Who we are</h2>
    ...
    <div class="md:flex mt-12 md:mt-24">
        <h2 class="flex-1 text-lg md:text-xl md:mt-2.5 lg:text-2xl font-display text-primary-950 md:text-left">Our goal</h2>
        <p class="max-w-3xl mr-auto text-4xl font-bold tracking-tight sm:text-6xl font-display text-primary-900 md:text-right">
            We aim to enable biosecurity-conscious people to contribute to a biosecure future.
        </p>
    </div>

    <section class="mt-12 md:mt-24">
        <h2 class="text-2xl md:text-4xl tracking-tight font-bold font-display text">Our team</h2>
    ...
    <section class="mt-12 md:mt-24">
        <h2 class="text-lg md:text-2xl font-display text-primary-950">Contact us at</h2>
        <p class="max-w-3xl  text-3xl font-bold tracking-tight md:text-6xl font-display text-primary-900">
            team@biosecurity.world
        </p>
    </section>

    <section
        class="mt-12 md:mt-24 relative isolate overflow-hidden bg-primary-900 px-6 py-24 text-center shadow-2xl rounded-3xl sm:px-16">
