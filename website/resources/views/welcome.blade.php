...
<body class="h-full antialiased w-full">
    ...
    <div class="w-full h-full flex px-36 rounded-3xl">
        <aside class="relative">
            <div class="w-full h-full max-w-lg border-r divide-y border-y border-l rounded-tl-3xl flex flex-col">
                <section class="p-6 bg-white rounded-tl-3xl">
                ...
                <section class="p-6 bg-gray-50 flex-grow">
            ...
            <div class="absolute left-[calc(26rem+1px)] top-0 z-20 w-full h-full max-w-md border-t" id="entry-aside"></div>
            <div class="absolute left-[calc(26rem+1px)] top-0 z-20 w-full h-full max-w-md border-t flex justify-center border-r bg-gray-50 rounded-r-3xl pt-16 htmx-indicator" id="entry-loader">
        ...
        <main class="w-full h-full relative border-y border-r rounded-tr-3xl">
            <section data-state="error" aria-hidden="true"
                     class="app-state state-inactive flex items-center justify-center">
