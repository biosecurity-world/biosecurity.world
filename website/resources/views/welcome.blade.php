    ...
    <div class="w-full h-full px-36 rounded-3xl">
        <div class="flex h-full">
            <aside class="relative">
                ...
                <div class="absolute left-[calc(26rem+1px)] top-0 z-20 w-full h-full max-w-md border-y" id="entry-aside"></div>
                <div class="absolute left-[calc(26rem+1px)] top-0 z-20 w-full h-full max-w-md border-y pointer-events-none flex justify-center border-r bg-gray-50 rounded-r-3xl pt-16 htmx-indicator" id="entry-loader">
        ...
        <footer aria-labelledby="footer-heading" class="mt-12 border-t border-gray-900/10 py-4">
            ...
            <div class="flex justify-between">
                ...
                <ul class="flex space-x-4">
                    ...
                    <li>
                        <a href="https://github.com/biosecurity-world/biosecurity.world" class="inline-flex text-sm underline text-gray-700">
